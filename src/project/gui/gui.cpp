...
void	gui::play_game()
{
	...
	_project->set_interface(new game(_graphic, _config, _project, false));
}

void	gui::play_multiplayer_game()
{
	std::cout << "gui: starting game...\n";
	_graphic->setEventReceiver(nullptr);
	_project->set_interface(new game(_graphic, _config, _project, true));
}
